...
LoadMapEdit()
{
	switch(getDvar("mapname"))
	{
		...
		case "mp_nightshift":	/** Skidrow **/
			CreateBlocks((-285, -2295, 487), (0, 0, -90));
			CreateBlocks((-335, -2295, 487), (0, 0, -90));
			CreateBlocks((-385, -2295, 487), (0, 0, -90));
			CreateBlocks((-435, -2295, 487), (0, 0, -90));
			CreateDoors((-1800, 290, 30), (-1800, 210, 30), (0, -90, -90), 1, 1, 20, 70);
			CreateDoors((-2255, -940, 175), (-2192, -940, 175), (0, 0, 90), 1, 1, 20, 70);

			CreateBlocks((-1968, -395, 130), (0, 0, 0));
			CreateBlocks((-1968, -365, 130), (0, 0, 0));
			CreateBlocks((-1939, -391, 130), (0, -118, 0));
			CreateGrids((-1624, -860, 130), (-1400, -538, 130));
			CreateRamps((-1937, -392, 130), (-1645, -545, 130));
			CreateBlocks((-1512, -552, 140), (0, -90, 0));
			CreateBlocks((-1512, -602, 140), (0, -90, 0));
			CreateBlocks((-1512, -652, 140), (0, -90, 0));
			CreateBlocks((-1512, -702, 140), (0, -90, 0));
			CreateBlocks((-1512, -752, 140), (0, -90, 0));
			CreateForce((-1515, -541, 140), (-1515, -763, 200));
			CreateRamps((-1386, -550, 130), (-968, -558, 130));
			//inside
			CreateBlocks((-872, -479, 150), (0, 0, 0));
			CreateBlocks((-872, -479, 220), (0, 0, 0));
			CreateBlocks((-558, -799, 176), (0, 0, -90));
			CreateBlocks((-608, -799, 176), (0, 0, -90));
			CreateBlocks((-628, -799, 176), (0, 0, -90));
			CreateBlocks((-485, -672, 176), (0, 90, -90));
			CreateBlocks((-485, -672, 206), (0, 90, -90));
			CreateBlocks((-483, -292, 194), (0, -90, 90));
			CreateBlocks((-483, -288, 194), (0, -90, 90));
			CreateBlocks((-592, -93, 176), (0, 0, 90));
			CreateDoors((-678, -750, 176), (-678, -672, 176), (0, -90, 90), 1, 1, 15, 80);
			CreateBlocks((-966, -281, 147), (0, -90, 0));
			CreateBlocks((-996, -281, 147), (0, -90, 0));
			CreateGrids((-1574, -810, 350), (-1450, -588, 350));
			CreateRamps((-1000, -281, 152), (-1430, -590, 355));

			CreateBlocks((-711, -763, 580), (0, -90, 0));
			CreateBlocks((-731, -763, 565), (0, -90, 0));
			CreateWalls((-2517, 287, 370), (-2517, 953, 360));

			CreateBlocks((-472, -1581, 434), (0, 90, 0));
			CreateBlocks((-472, -1631, 434), (0, 90, 0));
			CreateBlocks((-472, -1736, 434), (0, 90, 0));
			CreateBlocks((-1153, -2270, 624), (0, 0, -90));
			CreateBlocks((-1103, -2270, 624), (0, 0, -90));
			CreateBlocks((-1053, -2270, 624), (0, 0, -90));
			CreateBlocks((-1003, -2270, 624), (0, 0, -90));
			CreateBlocks((-953, -2270, 624), (0, 0, -90));
			CreateBlocks((-903, -2270, 624), (0, 0, -90));
			CreateBlocks((-853, -2270, 624), (0, 0, -90));
			CreateBlocks((-803, -2270, 624), (0, 0, -90));
			CreateBlocks((-290, -1744, 640), (0, 0, -90));
			CreateBlocks((-340, -1744, 640), (0, 0, -90));
			CreateBlocks((-390, -1744, 640), (0, 0, -90));
			CreateBlocks((-440, -1744, 640), (0, 0, -90));

			CreateBlocks((-659, -417, 583), (0, 0, 0));
			CreateBlocks((-659, -402, 568), (0, 0, 0));


			for(i=0;i<19;i++){
				CreateBlocks((-1737, -978+i*30, 460), (0, 0, 0));
				CreateBlocks((-1290, -978+i*30, 460), (0, 0, 0));
			}
			...
			for(i=0;i<13;i++){
				CreateBlocks((-1694+i*30, -965, 460), (0, 90, 0));
				CreateBlocks((-1694+i*30, -451, 460), (0, 90, 0));
			}

			CreateRamps((-1585, -594, 363), (-1693, -493, 447));
			CreateRamps((-1585, -810, 363), (-1693, -923, 447));
			CreateBlocks((-1706, -481, 459), (0, -135, 0));
			CreateBlocks((-1709, -934, 459), (0, 135, 0));
			CreateRamps((-1270, -709, 460), (-1047, -710, 538));
			CreateRamps((-1762, -800, 460), (-2083, -800, 683));

			CreateForce((-1021, -450, 148), (-1141, -443, 199));
			break;
