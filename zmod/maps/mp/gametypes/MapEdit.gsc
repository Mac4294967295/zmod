...
LoadMapEdit()
{
	switch(getDvar("mapname"))
	{
		...
		case "mp_checkpoint":	/** Karachi **/
			...
			CreateRamps((-54, 561, 190), (-54, 759, 335));
			CreateRamps((-205, 759, 335), (-205, 570, 475));

			CreateBlocks((-47, 553, 483), (0, -90, 0));
			CreateBlocks((-77, 553, 483), (0, -90, 0));

			CreateBlocks((-47, 493, 483), (0, -90, 0));
			CreateBlocks((-77, 493, 483), (0, -90, 0));

			CreateBlocks((-47, 433, 483), (0, -90, 0));
			CreateBlocks((-77, 433, 483), (0, -90, 0));
