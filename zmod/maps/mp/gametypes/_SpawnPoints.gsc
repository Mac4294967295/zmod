...
SetSpawnPoint(team, x_cord, y_cord, z_cord)
{	
...
{	
	//[Attackers/Defenders][Spawnpoint#][x/y/z cords]
	level.arraySpawnPoint[2][50][3] = [];
	NullSpawnPoints();
	LoadSpawnPoints();
}
...
{	
	switch(getDvar("mapname"))
	{
		case "mp_rust":
			...
			SetSpawnPoint("allies", 700, 1400, 280);
			...
			SetSpawnPoint("axis", 1500, 880, -226);
			break; 
